...
let text = "Đm Giáng sinh rảnh quá không có gì làm =))) Nên là làm cái trò con bò này để muốn làm cùng 1 cái trend vớ vẩn thôi =)))) \n Làm cùng được không :D"
            ...
            if(currentIndexTitle < charArrTitle.length){
                ...
                textIntervalContent = setInterval(function () {
                  if (currentIndexContent < charArrContent.length) {
                    cartPageBottomP.innerHTML += charArrContent[currentIndexContent];
                    currentIndexContent++;
                    console.log(currentIndexContent);
                      ...
                      var $image = $("<img>", {
                        class: "card-image",
                        src: "test.jpg", // Replace with the actual path to your image
                        alt: "Card Image",
                      });
                      $(".cart-page-bottom").append($image);
                    }
                },25)
            }
        },100)
